...
#define _BLOCK_TYPE_IS_VALID(use)                                                                                              \
    (((use) == _NORMAL_BLOCK) || ((use) == _FREE_BLOCK) || ((use) == _CRT_BLOCK) || ((use) == _IGNORE_BLOCK) ||                \
     ((use) == _CLIENT_BLOCK) || ((use) == _MAX_BLOCKS))
#define _BLOCK_TYPE_IS_USED(use) (((use) == _NORMAL_BLOCK) || ((use) == _CRT_BLOCK) || ((use) == _CLIENT_BLOCK))
