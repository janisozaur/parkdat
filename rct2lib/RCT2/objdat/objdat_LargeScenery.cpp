                         ...
                         WORD baseHeight, WORD imgWidth, WORD imgHeight)
{
    ...
    {
    case VIEW_SE:
        isoOrigin.Set(imgWidth / 2, baseTop_y + TILE_YSTEP);
        break;
    case VIEW_NE:
        isoOrigin.Set(imgWidth - TILE_XSTEP, baseTop_y + imgHeight_Flip / 2);
        break;
    case VIEW_NW:
        isoOrigin.Set(imgWidth / 2, imgHeight - TILE_YSTEP);
        break;
    case VIEW_SW:
        isoOrigin.Set(TILE_XSTEP, baseTop_y + imgHeight_Flip / 2);
        break;
    }
    // col=(i%numCols);
