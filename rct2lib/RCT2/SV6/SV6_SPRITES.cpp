...
bool SV6_FILE::EmptyRidesOfGuests(SPRITESTATS * spritestats, SV6_SPRITESTRUCT * spriteBlock)
{
    ...
    WORD index;
    RCT2_RIDESTRUCT
    vehiOwner, *rideArray = &this->fileDataA.parkData.rides[0];
    index = spritestats->statsA.firstVehicle;
    while (index != RCT2_WORD_EMPTY)
    {
        memcpy(&vehiOwner, &(rideArray[spriteBlock[index].byte30.ownerRide]), sizeof(vehiOwner));
...
int RemoveSprite(WORD index, WORD prevI, WORD nextI, WORD * prevFreeI, SPRITETYPE spritetype, SPRITESTATS * spritestats,
                 SV6_SPRITESTRUCT * cursprite, SV6_SPRITESTRUCTARRAY * sprites)
{
...
int SV6_FILE::SpriteFunc(SPRITEFUNCCLASS fclass, SPRITEFUNCID func)
{
...
#define cursprite ((*spriteBlock)[index])
    ...
    RCT2_RIDESTRUCT rideOn, *rideArray = &this->fileDataA.parkData.rides[0];

    WORD newAttendance;

    memcpy(&spritestats, &this->fileDataA.parkData.spriteStats, sizeof(SPRITESTATS));
    ...
    case SF_FLOAT:
        ...
        spriteBlock = (SV6_SPRITESTRUCTARRAY *)(&this->fileDataA.parkData.sprites);
...
//	SuspendRCT2();
        ...
        memcpy(spriteBlock, spritePtrBase, sizeof(*spriteBlock));

        memcpy(&spritestats, &this->fileDataA.parkData.sprites, sizeof(SPRITESTATS));
                ...
                if (cursprite.persontype == SPR_PT_GUEST)
                {
                    ...
                    case GUEST_REMOVEALL:
                        ...
                        case 17: // at _____*,
                            ...
                            memcpy(&rideOn, &(rideArray[cursprite.union52.personStruct.unkCurRideOnI_A]), sizeof(rideOn));
        ...
        memcpy(&this->fileDataA.parkData.sprites, spriteBlock, sizeof(*spriteBlock));

        memcpy(&this->fileDataA.parkData.spriteStats, &spritestats, sizeof(SPRITESTATS));
