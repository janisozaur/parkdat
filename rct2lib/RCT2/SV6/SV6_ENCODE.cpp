...
DoEncodeSv6:
{
    i = EncodeSv6Chunk(encodeType, bytesleft, &cc.header, (BYTE *)(&cc.buffer), sz(s.header), &s.header_header,
                       (BYTE *)(&s.header), i);
    chunkI++;
    ...
    */
    ...
    i = EncodeSv6Chunk(encodeType, bytesleft, &cc.header, (BYTE *)(&cc.buffer), sz(s.availableItems), &s.availableItems_header,
                       (BYTE *)(&s.availableItems), i);
    chunkI++;
    i = EncodeSv6Chunk(encodeType, bytesleft, &cc.header, (BYTE *)(&cc.buffer), sz(s.timeData), &s.timeData_header,
                       (BYTE *)(&s.timeData), i);
    chunkI++;
    i = EncodeSv6Chunk(encodeType, bytesleft, &cc.header, (BYTE *)(&cc.buffer), sz(s.parkMap), &s.parkMap_header,
                       (BYTE *)(&s.parkMap), i);
    chunkI++;
    i = EncodeSv6Chunk(encodeType, bytesleft, &cc.header, (BYTE *)(&cc.buffer), sz(s.parkData), &s.parkData_header,
                       (BYTE *)(&s.parkData), i);
    chunkI++;
